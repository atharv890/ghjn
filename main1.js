...
jk=document.getElementById("Questionname").innerHTML="Question turn : "+player1;
nk=document.getElementById("Answername").innerHTML="Answer turn : "+player2;
function check(){
...
document.getElementById("Questionname").innerHTML=nk;
document.getElementById("Answername").innerHTML=jk;
